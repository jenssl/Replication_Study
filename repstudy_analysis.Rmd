...
#for the remaining data create a new variable called "overstate" and then 
#find people who overstated once and accurately stated once and calculate the total number of words for each person
#run paired t-tests
